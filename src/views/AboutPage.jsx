                  ...
                  <div className="about-hero-copy">
                    <div className="about-hero-copy-column">
                      <p>
                        ...
                        product development, and modern web applications. Over
                        the past several years, I've worked on complex software
                        systems across both defense and commercial sectors.
                        Early in my career at SSE, I helped develop virtual
                    ...
                    <div className="about-hero-copy-column">
                      ...
                      <p>
                        ...
                        software, both through independent projects and
                        freelance work helping small businesses establish a
                        modern, professional presence online. I enjoy creating
        ...
        <section className="about-copy-section-mobile">
          <div className="about-copy-mobile">
            ...
            <p>
              ...
              company&apos;s core platform, managed a small team of engineers
              and artists, and worked closely with customers to shape product
            ...
            <p>
              ...
              enjoy creating tools that solve real problems, whether that&apos;s
              a custom website, a web application, or a product like CatchLogs,
              a fishing log application I built to help anglers track and
              analyze their catches. Outside of work, I enjoy traveling,
              spending time on the water, and getting outdoors whenever I can.
              Much of my free time is spent with my partner and our dog, Suki,
              exploring new places or simply enjoying a quiet day by the lake.
            </p>
          </div>
        </section>
      </main>
